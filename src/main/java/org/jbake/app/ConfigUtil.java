...
public class ConfigUtil {
    ...
    public static interface Keys {
        ...
        /**
         * Folder where assets are stored, they are copied directly in output folder and not
         * processed
         */
    ...
    public static CompositeConfiguration load(File source) throws ConfigurationException {
        ...
        if (customConfigFile.exists()) {
            if (!LEGACY_CONFIG_FILE_WARNING_SHOWN) {
                LOGGER.warn(String.format("You have defined a part of your JBake configuration in %s located at: %s",
                        LEGACY_CONFIG_FILE, customConfigFile.getParent()));
                LOGGER.warn(String
                        .format("Usage of this file is being deprecated, please rename this file to: %s to remove this warning",
                                CONFIG_FILE));
